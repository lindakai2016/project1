<template>
    ...
    <div class="toTrain bookForm">
        ...
        <p class="fi">
            ...
            <poiInput class="rval v_ePos" :err="poiItemErr" :cityCode="sCtCode" :item="poiItem" @change="poiChange" @changeCity="poiCityChange" @blur="poiItemBlur"></poiInput>
        </p>
        <p class="fi">
            <label class="lb needed">火车站</label>
            <depInput class="rval v_train" :err="depItemErr" :cityCode="eCtCode" :item="depItem" :type="1" @change="depChange" :cityId="cityId" @blur="depItemBlur"></depInput>
        </p>
        <p class="fi">
