<template>
    <div class="accountList">
        ...
        <div class="content" v-show="init">
            ...
            <div class="filter">
                <div class="fi">
                    <label class="lb">员工姓名/手机号</label>
                    <inputGr class="input" placeholder="员工姓名/手机号搜索" v-model="keyword" clear="1"></inputGr>
                </div>
                <div class="fi">
        ...
        <basePopup v-model="showNewAc" :closeOnClickout="true">
            <newAccount @exit="exitNewAcDlg" @submitOk="newAcOk" :type="0" :key="+showNewAc"></newAccount>
        </basePopup>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        getAccountList: _.debounce(function() {
            let {keyword, state, page, pageSize} = this;
