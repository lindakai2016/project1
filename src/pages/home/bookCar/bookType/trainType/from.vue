<template>
    ...
    <div class="fromTrain bookForm">
        ...
        <p class="fi">
            ...
            <depInput class="rval v_train" :err="errParam=='depItem'" :type="1" @change="depChange" @changeCity="depCityChange"></depInput>
        </p>
        <p class="fi">
            <label class="lb needed">目的地</label>
            <poiInput class="rval v_ePos" :err="errParam=='poiItem'" @change="poiChange" :cityId="cityId"></poiInput>
        </p>
        <p class="fi">
