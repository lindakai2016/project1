<template>
    ...
    <div class="cityCarType bookForm">
        ...
        <p class="fi">
            ...
            <poiInput class="rval v_sPos" :err="errParam=='poiItem'" @change="poiChange" @changeCity="poiCityChange"></poiInput>
        </p>
        <p class="fi">
            <label class="lb needed">目的地</label>
            <poiInput class="rval v_ePos" :err="errParam=='poiItem2'" @change="poiChange2" :cityId="cityId"></poiInput>
        </p>
        <p class="fi">
...
export default {
    ...
    methods: {
        ...
        checkParam() {
            ...
            if(!this.poiItem2.name) {
                this.formErr = "目的地点不能为空";
                this.errParam = "poiItem2"
                return false;
            }
            if(!this.rideNum){
